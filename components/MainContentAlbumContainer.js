...
// import { albums } from '@/data/albums' //albums data
// import AlbumCard from './AlbumCard'

// const MainContentAlbumContainer = () => {
...
//     return (
//         <div className='p-5 '>
//             <h2 className='text-white text-2xl font-bold'>Featured Albums</h2>
...
//                     ref={scrollRef}
//                     id="albumcontainer"
//                     className='flex overflow-x-auto gap-2 no-scrollbar w-full'
//                 >
//                     {albums.map((data) => {
//                         return (
//                             <AlbumCard
...
// export default MainContentAlbumContainer
